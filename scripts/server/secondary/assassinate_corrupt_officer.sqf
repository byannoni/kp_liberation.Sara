...
{([(getpos _spawn_marker) getPos [50, random 360], _x, true] call KPLIB_fnc_spawnVehicle) addMPEventHandler ['MPKilled', {_this spawn kill_manager}]; } foreach _vehtospawn;
...
_officer addMPEventHandler ["MPKilled", {_killer = this}]
...
_units_in_area = allunits side east inArea [_spawn_marker, 500, 500]
